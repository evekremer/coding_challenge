...
class SetHandlerTest < BaseTest
  ...
  def test_simple_prepend
    ...
    expected_get = {flags: @set_storage_obj.flags, expdate: @set_storage_obj.expdate, length: new_data_block.length.to_s, cas_key: @cache_handler.cas_key, data_block: new_data_block}

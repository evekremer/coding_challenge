...
# Unit test for Memcached::Util module for validate_*! methods
class UtilValidateTest < BaseTest
  include Memcached::Util

  ####### Test validate_command_name! method
  
  ####### Test validate_and_remove_ending! method
  
  ####### Test validate_data_block! method

...
class PreAppendTest < BaseTest
  ...
  def test_simple_append
    v1 = "start"
    send_storage_cmd(Memcached::SET_CMD_NAME, key, 2, 3000, v1.length, false, v1, false)
    assert_equal Memcached::STORED_MSG, read_reply

    v2 = "end"
    send_storage_cmd(Memcached::APPEND_CMD_NAME, key, 2, 3000, v2.length, false, v2, false)
    assert_equal Memcached::STORED_MSG, read_reply
  ...
  def test_missing_key_append
    value = "end"
    send_storage_cmd(Memcached::APPEND_CMD_NAME, key, 2, 3000, value.length, false, value, false)
  ...
  def test_empty_value_append
    send_storage_cmd(Memcached::SET_CMD_NAME, key, 2, 3000, value.length, false, value, false)
    assert_equal Memcached::STORED_MSG, read_reply

    send_storage_cmd(Memcached::APPEND_CMD_NAME, key, 2, 400, 0, false, nil, false)
    assert_equal Memcached::STORED_MSG, read_reply
  ...
  def test_no_reply_append
    ...
    send_storage_cmd(Memcached::APPEND_CMD_NAME, key, 4, 400, value2.length, false, value2, true)
  ...
  def test_simple_prepend
    v2 = "end"
    send_storage_cmd(Memcached::SET_CMD_NAME, key, 2, 3000, v2.length, false, v2, false)
    assert_equal Memcached::STORED_MSG, read_reply

    v1 = "start"
    send_storage_cmd(Memcached::PREPEND_CMD_NAME, key, 2, 3000, v1.length, false, v1, false)
    assert_equal Memcached::STORED_MSG, read_reply
  ...
  def test_empty_value_prepend
    ...
    send_storage_cmd(Memcached::PREPEND_CMD_NAME, key, 2, 400, 0, false, nil, false)
    assert_equal Memcached::STORED_MSG, read_reply
  ...
  def test_no_reply_prepend
    ...
    send_storage_cmd(Memcached::PREPEND_CMD_NAME, key, 4, 400, value2.length, false, value2, true)
  ...
  def test_wrong_length_parameter
    ...
    v1 = "start"
    send_storage_cmd(Memcached::PREPEND_CMD_NAME, key, 2, 3000, v1.length-5, false, v1, false)
    assert_equal Memcached::CLIENT_ERROR + "<length> (#{v1.length-5}) is not equal to the length of the item's data_block (#{v1.length})" + Memcached::CMD_ENDING, read_reply
    
    # Try appending with smaller length parameter than the actual length
    v2 = "end"
    send_storage_cmd(Memcached::APPEND_CMD_NAME, key, 2, 3000, v2.length-1, false, v2, false)
    assert_equal Memcached::CLIENT_ERROR + "<length> (#{v2.length-1}) is not equal to the length of the item's data_block (#{v2.length})" + Memcached::CMD_ENDING, read_reply
  ...
  def test_value_too_long_prepend
    ...
    send_storage_cmd(Memcached::PREPEND_CMD_NAME, key, 2, 3000, v2.length, false, v2, false)
